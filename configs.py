...
class Config(object):
	...
	OWNER_ID = int(os.environ.get("OWNER_ID", 6274275394))
	CAPTION = "By Kawaki ✨"
...
Hi, I am Kawaki ✨ and I Am Watermark Adder Bot!
...
__Note: I can only process one video at a time. As my server is Heroku, my health is not good. If you have any issues with Adding Watermark to a Video, then please Report at [Support Group](https://t.me/MXNITRO).__
